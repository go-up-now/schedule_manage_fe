...
export const instructorValidationSchema = Yup.object().shape({
  ...
  privateEmail: Yup.string().required("Vui lòng nhập email cá nhân")
    .email('Email không hợp lệ'),
    ...
    <div className="px-2 pt-1 ">
      ...
      <div>
        <TextField
          ...
          className="p-0 mt-2"
          className1={`w-full ${formik.touched.schoolEmail && formik.errors.schoolEmail && 'border-red-500'}`}
          {...formik.getFieldProps('schoolEmail')}
          disabled={areSelectBoxesDisabled}
        />
        {formik.errors.schoolEmail && formik.touched.schoolEmail && (
          <div className='text-red-500'>{formik.errors.schoolEmail as string}</div>
        )}
      </div>
      <div>
        <TextField
          ...
          className="p-0 mt-2"
          className1={`w-full ${formik.touched.privateEmail && formik.errors.privateEmail && 'border-red-500'}`}
          {...formik.getFieldProps('privateEmail')}
          disabled={areSelectBoxesDisabled}
        />
        {formik.errors.privateEmail && formik.touched.privateEmail && (
          <div className='text-red-500'>{formik.errors.privateEmail as string}</div>
        )}
      </div>
      <div>
        <TextField
